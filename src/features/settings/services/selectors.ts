...
export const selectSettingsTopics = createSelector(
  selectAllSettings,
  (settings) => settings.topics
);

export const selectQuestionAmountValues = createSelector(
  selectAllSettings,
  (settings) => settings.questionAmountValues
);

export const selectAnswerAmountValues = createSelector(
  selectAllSettings,
  (settings) => settings.answerAmountValues
);

export const selectQuestionTime = createSelector(
  selectAllSettings,
  (settings) => settings.questionTime
);
